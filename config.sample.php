<?php
/*
** This file contains example settings for Southparkfan's cms. To configure Southparkfan's cms, you should edit this file and save it under the name "config.php".
** Since: 09/2014
